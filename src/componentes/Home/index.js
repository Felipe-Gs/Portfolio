  ...
  return (
    ...
    <div style={{color:'whitesmoke', justifyContent:"center", display:"flex", alignItems:'center', margin:10,}}>
          <div style={{padding:10, justifyContent:'center', display:"flex", flexDirection:"column", marginTop:'5%'}}>
            ...
            <div>
              <Button href='https://docs.google.com/uc?export=download&id=1f7eY8nlTfTiDCsVemW8eAX7MuJLM8CLo' target='_blanck' variant="dark" style={{width:'50%', marginTop:'2%'}}>Baixe meu curriculo</Button> 
            </div>
          </div>
      </div>
